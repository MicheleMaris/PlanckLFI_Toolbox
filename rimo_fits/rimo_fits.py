...
__VERSION__="""Version 1.7 - 29 May 2012 - 2012 Jun 25 - 2012 Nov 21 - 2013 Jan 24 - 2013 Jan 25 - 2013 Apr 18 - 2014 Mar 20 - 2014 May 12 - 2014 Oct 20 - By M. Maris, INAF / Trieste Astronomical Observatory and Planck/LFI DPC"""
...
def Detector2Arm(arm) :
   ...
   if _arm=='s' or _arm=='x' or _arm=='0' : return ['S','X',1]
   if _arm=='m' or _arm=='y' or _arm=='1' : return ['M','Y',0]
   return None
...
class LFI_BandPass_Fits(_BandPass_Fits_Base) :
   ...
   def detector2horn(self,Detector) :
      ...
      if 27 <= n and n <= 28 :
         ...
         return None
   def __call__(self,Detector,skip_NullWavenumbers=True,skip_NullTransmission=False,skip_BadFlag=True,fft=False,fftFilt=None,detectorIndex=None) :
